				...
				<div class="col-xl-12">
						<div class="card mg-b-20">
							<div class="card-header pb-0">
								...
								<a class="modal-effect btn btn-outline-primary btn-block" data-effect="effect-just-me" data-toggle="modal" href="#modaldemo8">Add Section</a>
									...
									<table id="example" class="table key-buttons text-md-nowrap" style="font-size: 12px; text-align:center;">
										<thead>
											<tr>
												...
												<th  style="font-size: 12px;" class="border-bottom-0">Section Name</th>
										...
										<tbody>
											...
											<tr>
												...
												<td><a class="btn btn-primary" href="{{url('updatesection')}}/{{$data->id}}">Update</a></td>
												<td> <a class="btn btn-danger " onclick="return confirm('Are you sure')" href="{{url('deletesection',$data->id)}}">Delete</a> </td>	
                    ...
                    <form action="{{url('addsections')}}" method="POST">
						...
						<div class="form-group">
							<label for="exampleInputEmail">Notes </label>
