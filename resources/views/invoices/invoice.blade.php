...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">الفواتير</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ معايتة طباعة الفاتورة</span>
						</div>
					</div>
						...
						<div class=" main-content-body-invoice" id="print">
							<div class="card card-invoice">
								<div class="card-body">
									...
									<div class="row mg-t-20">
										<div class="col-md">
											...
											<div class="billed-to">
												...
												<p>4033 Patterson RoInvoice Noad, Staten Island, NY 10301<br>
												Tel No: 324 445-4544<br>
												Email: youremail@companyname.com</p>
											</div>
										</div>
										<div class="col-md">
											...
											<p class="invoice-info-row"><span>القسم</span> <span>{{$invoice->sectionm->section_name}}</span></p>
										</div>
									</div>
									<div class="table-responsive mg-t-40">
										<table class="table table-invoice border text-md-nowrap mb-0">
											...
											<tbody>
												...
												<tr>
													<td>نسبة الضريبة</td>
													<td class="tx-right">{{$invoice->Rate_VAT}}</td>
												</tr>
												<tr>
													<td>قيمة الخصم</td>
													<td class="tx-right">{{number_format($invoice->Discount,2)}}</td>
												</tr>
												<tr>
												<td class="tx-right tx-uppercase tx-bold tx-inverse">اجمالي شامل الضريبة</td>
									...
									<hr class="mg-b-40">
									<button href="#" class="btn btn-danger float-left mt-3 mr-2">
										<i class="mdi mdi-printer ml-1" id="print_Button" onclick="printDiv()"></i>Print
									</button>
								</div>
							</div>
						</div>
