					...
					<div class="col-xl-12">
						<div class="card mg-b-20">
							<div class="card-header pb-0">
								...
								@endcan
								@can('تصدير EXCEL')
								<a class="btn btn-primary" href="{{url('export_invoices')}}">EXCEL تصدير </a>
								@endcan
							</div>
												...
												<td>{{$invoices->note}}</td>
													...
													<td>
														...
														<div class="dropdown-menu tx-13">
															@can('تعديل الفاتورة')
															<a class="dropdown-item" href="{{url('edit_invoice')}}/{{$invoices->id}}"><i
                                                                class="text-success fas fa-exchange-alt"></i>&nbsp;&nbsp; تعديل الفاتورة</a>
															@endcan
															@can('حذف الفاتورة')
															<a class="dropdown-item" onclick="return confirm('Are you sure?');" href="{{url('delete_invoice')}}/{{$invoices->id}}"><i
                                                                class="text-danger fas fa-exchange-alt"></i>&nbsp;&nbsp; حذف</a>
															@endcan
															@can('تغير حالة الدفع')
															<a class="dropdown-item"  href="{{url('status_show')}}/{{$invoices->id}}"><i
                                                                class="text-warning fas fa-exchange-alt"></i>&nbsp;&nbsp;  تغير حالة الدفع</a>
															@endcan
															@can('ارشفة الفاتورة')
															<a class="dropdown-item" onclick="return confirm('Are you sure move to archive?');" href="{{url('move_to_archive')}}/{{$invoices->id}}" 
                                                           ><i
                                                                class="text-warning fas fa-exchange-alt"></i>&nbsp;&nbsp;نقل الي
                                                            الارشيف</a>   
															@endcan
															@can('طباعةالفاتورة')
                                                        <a class="dropdown-item" href="{{url('print_invoice')}}/{{ $invoices->id }}"><i
