			...
			<div class="main-sidemenu">
				<div class="app-sidebar__user clearfix">
					<div class="dropdown user-pro-body">
						<div class="">
							<img alt="user-img" class="avatar avatar-xl brround" src="{{URL::asset('assets/img/faces/index.png')}}"><span class="avatar-status profile-status bg-green"></span>
						</div>
						<div class="user-info">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						@can('الفواتير المدفوعة')
							<li><a class="slide-item" href="{{ url('/'. $page='invoices_cash')}}">الفواتيبر المدفوعة</a></li>
						@endcan	
