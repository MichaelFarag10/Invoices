...
@section('content')
    ...
    <div class="container-fluid">
        <div class="row no-gutter">
            ...
            <div style='background-color: white;' class="col-md-6 col-lg-6 col-xl-7 d-none d-md-flex ">
                <div class="row wd-100p mx-auto text-center">
                    <div class="col-md-12 col-lg-12 col-xl-12 my-auto mx-auto wd-100p">
                        <img style="width: 90%; border-radius: 15px;" src="{{URL::asset('assets/img/2.jpg')}}" class="my-auto ht-xl-80p wd-md-100p wd-xl-80p mx-auto" alt="logo">
                    </div>
                </div>
            </div>
